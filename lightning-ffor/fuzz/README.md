...
[accept][candidate]`, with candidate being a manifest, complete provision, or
`[u16 manifest_length][u16 record_length][manifest][record][body]` for body verification.
Its seeds use the
six public Appendix D setups and manifests, fetch pages and encrypted records generated by the
pinned Beignet implementation. It checks candidate plaintext terms and preimage hashes,
but never decrypts ciphertext or treats those candidates as authenticated witness evidence.
