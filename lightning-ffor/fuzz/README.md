...
The `witness` target checks strict provision/ack encodings and authenticated receiver manifest
decoding. It accepts raw acknowledgement bytes or `[u16 init_length][u16 accept_length][init]
[accept][candidate]`, with candidate being a manifest or complete provision. Its seeds use the
six public Appendix D setups and manifests generated by the pinned Beignet implementation.
